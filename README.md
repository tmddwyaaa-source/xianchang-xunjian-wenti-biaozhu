...
管理端列表（状态 / 优先级 / 提交人筛选，可改状态、查看详情、删除）：

![管理端问题列表](docs/demo/admin-list.png)

管理端详情弹窗（完整描述与独立 X / Y / Z 坐标）：

![管理端问题详情](docs/demo/admin-detail.png)

手机 AR（扫描中、特征点数量、彩色标记、右上角账号菜单）：

![手机 AR 扫描与标记](docs/demo/mobile-ar-scan.jpg)
